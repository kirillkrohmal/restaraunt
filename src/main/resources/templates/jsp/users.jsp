...
<body>
<script type="text/javascript" src="js/topjava.common.js" defer></script>
<script type="text/javascript" src="js/topjava.users.js" defer></script>
    ...
    <div class="container">
        ...
        <table class="table table-striped" id="datatable">
            ...
            <c:forEach items="${users}" var="user">
                <jsp:useBean id="user" type="com.restarauntvote.restarauntservice.model"/>
                <tr>
